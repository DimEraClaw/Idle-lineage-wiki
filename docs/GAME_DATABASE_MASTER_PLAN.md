...
| Knowledge | GameConcept、Mechanic、Formula、ResearchTopic | 玩家可搜尋術語、角色能力、共用機制、公式與研究入口；作為角色能力查詢的正式 owner | Equipment、Skill、Monster、Interaction、System、Research |
...
- Knowledge Domain 將 STR、Accuracy、Haste 等玩家術語建模為可搜尋 Entity，並連接 Mechanics、Formula 與 Research；它不取代 System 的底層共用資料，也不接管 Equipment、Skill、Monster 等 Domain 主資料。正式契約見 `docs/GAME_CONCEPTS_CONTRACT.md` 與 `docs/KNOWLEDGE_DOMAIN_ARCHITECTURE.md`。
